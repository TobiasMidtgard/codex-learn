...
const Desk = (function () {
  ...
  function deskCss() {
    return [
      ...
      '.dsk-title{font-family:var(--mono);font-size:var(--t-label);letter-spacing:var(--tr-caps);',
      ...
      '.dsk-tab{padding:4px 12px;border-radius:7px;font-size:var(--t-meta);font-weight:600;color:var(--ink-3)}',
      '.dsk-tab:hover{color:var(--ink)}',
      '.dsk-tab[aria-selected=true]{background:var(--lime);color:var(--on-lime)}',
      '.dsk-where{flex:1;min-width:0;text-align:right;font-family:var(--mono);font-size:var(--t-label);',
      ...
      '  color:var(--ink-3);font-size:var(--t-body);line-height:1}',
      ...
      '.dsk-empty{color:var(--ink-3);font-size:var(--t-ui);line-height:1.75;margin:auto 0}',
      '.dsk-empty code{font-family:var(--mono);font-size:var(--t-meta);color:var(--code-ink);',
      ...
      '.dsk-ex{grid-column:1;text-align:left;font-family:var(--mono);font-size:var(--t-meta);',
      '  color:var(--ink-3);white-space:pre-wrap;word-break:break-word;line-height:1.5}',
      '.dsk-row:hover .dsk-ex{color:var(--ink-2)}',
      '.dsk-val{grid-column:1;text-align:left;font-family:var(--mono);font-size:var(--t-body);',
      '  color:var(--accent-ink);word-break:break-word;line-height:1.4}',
      '.dsk-val small{display:block;font-size:var(--t-label);color:var(--ink-3);margin-top:2px}',
      '.dsk-row.err .dsk-val{color:var(--bad);font-size:var(--t-ui)}',
      '.dsk-send{grid-row:1/span 2;grid-column:2;align-self:center;width:26px;height:26px;',
      '  border-radius:7px;color:var(--ink-3);font-size:var(--t-meta);opacity:0;transition:opacity .14s}',
      ...
      '.dsk-prev{min-height:16px;font-family:var(--mono);font-size:var(--t-label);color:var(--ink-3);',
      ...
      '.dsk-in .car{font-family:var(--mono);font-size:var(--t-read);color:var(--on-editor-lime);flex:none}',
      '.dsk-in input{flex:1;min-width:0;height:42px;border:0;background:none;outline:none;',
      '  color:var(--on-editor);font-family:var(--mono);font-size:var(--t-body)}',
      ...
      '  font-size:var(--t-label);letter-spacing:var(--tr-mono);color:var(--on-editor-2);border:1px solid var(--on-editor-line)}',
      ...
      '.dsk-tips{display:none;padding:10px 2px 0;font-size:var(--t-meta);line-height:1.7;color:var(--ink-3)}',
      '.dsk-tips.on{display:block}',
      '.dsk-tips b{color:var(--ink-2);font-weight:600}',
      '.dsk-tips code{font-family:var(--mono);font-size:var(--t-meta);color:var(--code-ink)}',

      /* notes */
      '.dsk-notebar{flex:none;display:flex;align-items:center;gap:6px;padding:9px 12px;',
      '  border-bottom:1px solid var(--line)}',
      '.dsk-pick{height:26px;padding:0 11px;border-radius:7px;font-size:var(--t-meta);font-weight:600;',
      ...
      '.dsk-saved{margin-left:auto;font-family:var(--mono);font-size:var(--t-label);color:var(--ink-3);',
      '  white-space:nowrap}',
      '.dsk-saved.warn{color:var(--amber)}',
      '.dsk-ta{flex:1;min-height:0;width:100%;resize:none;border:0;outline:none;padding:14px 16px;',
      '  background:var(--editor);color:var(--on-editor);font-family:var(--mono);font-size:var(--t-ui);',
      ...
      '  font-family:var(--mono);font-size:var(--t-label);color:var(--ink-3)}',
