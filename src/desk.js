...
const Desk = (function () {
  ...
  function evaluate(src, env) {
    ...
    try {
      ...
      return { ok: false, error: String((err && err.message) || err), pos: err && err.pos };
    } finally {
      delete e.assigned;
    }
  }
  ...
  function ensureStyle() {
    ...
    const css = [
      ...
      '.dsk-in .car{font-family:var(--mono);font-size:14px;color:var(--lime);flex:none}',
      ...
      '.dsk-in input::placeholder{color:var(--on-editor-3)}',
      ...
      '.dsk-mini.on{color:var(--lime);border-color:var(--lime-30);background:var(--lime-12)}',
      ...
      '.dsk-tips code{font-family:var(--mono);font-size:11.5px;color:var(--lime)}',
